...
/**
 * add or update cart product for a specific user
 * @param {number} productID The ID of the product
 * @param {number} quantity The quantity of the product
 * @return {Object} The data of the added or updated product in the user cart
 * @throws {Error} If there was a problem adding or updating the product
 */
export const addCartProduct = async (productID, quantity = 1) => {
	try {
		// construct url
		const url = cart_endpoint + "/products/";
		...
		// Handle any error that occurred during adding or updating the product
		const msg =
